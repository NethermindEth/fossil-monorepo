...
# Deploy 5 min vault
echo -e "${YELLOW}Deploying 1 month PitchLake Vault contract...${NC}"
ROUND_TRANSITION_DURATION_5M=60
AUCTION_DURATION_5M=60
ROUND_DURATION_5M=180
ALPHA_5M=1250 # 12.5% risk factor

echo -e "${BLUE}5 Min Vault constructor arguments:${NC}"
echo "  PITCHLAKE_VERIFIER_ADDRESS: $PITCHLAKE_VERIFIER_ADDRESS"
echo "  ETH_ADDRESS: $ETH_ADDRESS"
echo "  OPTION_ROUND_CLASS_HASH: $OPTION_ROUND_CLASS_HASH"
echo "  ALPHA: $ALPHA_5M"
echo "  STRIKE_LEVEL: $STRIKE_LEVEL"
echo "  ROUND_TRANSITION_DURATION: $ROUND_TRANSITION_DURATION_5M"
echo "  AUCTION_DURATION: $AUCTION_DURATION_5M"
echo "  ROUND_DURATION: $ROUND_DURATION_5M"
echo "  PROGRAM_ID: $PROGRAM_ID"
echo "  PROVING_DELAY: $PROVING_DELAY"
echo

sleep 5
PITCHLAKE_VAULT_ADDRESS_5M=$(starkli deploy $PITCHLAKE_VAULT_HASH $PITCHLAKE_VERIFIER_ADDRESS $ETH_ADDRESS $OPTION_ROUND_CLASS_HASH $ALPHA_5M $STRIKE_LEVEL $ROUND_TRANSITION_DURATION_5M $AUCTION_DURATION_5M $ROUND_DURATION_5M $PROGRAM_ID $PROVING_DELAY --account $STARKNET_ACCOUNT --rpc $STARKNET_RPC_URL -w | grep -o '0x[a-fA-F0-9]\{64\}' | head -1)
echo -e "${GREEN}5 Min Vault deployed at: ${BOLD}$PITCHLAKE_VAULT_ADDRESS_5M${NC}"
echo
...
echo "  5 Min Vault: $PITCHLAKE_VAULT_ADDRESS_5M"
echo
